/*
  ...
  - includes(Value [Mand], Start [Opt] Default 0) [ES6]--> Boolean
...
console.log(a.substring(a.length-3,a.length-1));//oo
...
console.log(a.endsWith("o",5));//false
console.log(a.endsWith("o",6));//true//jusqu'a longueur début par 1 n'est pas par 0
